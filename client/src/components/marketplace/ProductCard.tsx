...
export const ProductCard: React.FC<ProductCardProps> = ({ listing }) => {
  ...
  // Replace "Holy Grail" with "COLLECTOR GRADE"
  ...
  return (
    <div className="group relative bg-[#161616] border border-[#2A2A2A] hover:border-[#E10600] rounded overflow-hidden transition-all duration-200 flex flex-col justify-between text-left">
      {/* Clickable Image Container — Clean and Unobstructed */}
      <Link
        to={productUrl}
      ...
      >
        ...
        {/* Top Floating Badges: Rarity & Wishlist (No obstructive text over the photo) */}
        <div className="absolute top-2.5 left-2.5 right-2.5 flex items-start justify-between gap-1.5 z-10 pointer-events-none">
          ...
          <button
            ...
            className={`p-1.5 rounded bg-[#161616]/90 border transition-colors pointer-events-auto ${
              isSaved
      ...
      <div className="p-3.5 flex-1 flex flex-col justify-between space-y-3">
        <div className="space-y-1">
          ...
          {/* Price with Explicit Discount Percentage Pill */}
        ...
        {/* Full-Width Solid Red ADD TO CART Button */}
        <button
          type="button"
          onClick={handleAddToCart}
          className="w-full bg-[#E10600] hover:bg-[#B20404] text-white py-2 text-[11px] font-bold uppercase tracking-wider rounded transition-colors text-center shadow-sm"
        >
          ADD TO CART
        </button>
      </div>
